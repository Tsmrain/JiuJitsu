...
Brinda a los alumnos de la academia \textit{Corpo e Mente} un asistente técnico disponible las 24 horas que democratiza el aprendizaje guiado, reduce la frustración en etapas iniciales y promueve una práctica deportiva segura al corregir malas posturas.
...
\begin{itemize}
    ...
    \begin{itemize}
        \item \textbf{Profesor de Brazilian Jiu-Jitsu (BJJ) (Corpo e Mente):} Responsable del desarrollo técnico y evaluación biomecánica de los practicantes de Jiu-Jitsu (usuario primario de este sistema).
    ...
    \end{itemize}
    \item \textbf{Alumnos:} Estudiantes asignados a cada especialidad técnica.
\end{itemize}
