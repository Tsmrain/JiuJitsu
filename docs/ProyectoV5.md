...
> Archivos de texto/código volcados: **77**
> Binarios referenciados (no volcados): **54**
 ...
 "cells": [
  ...
  },
  {
   ...
   "source": [
    ...
    "embedding_model = SentenceTransformer(\"Qwen/Qwen3-VL-Embedding-2B\", device=\"cuda\", trust_remote_code=True)\n",
  ...
  },
  {
   ...
   "source": [
    ...
    "    try:\n",
    "        # Generar embeddings normalizados en lote (2048d)\n",
    "        vectores = embedding_model.encode(textos, normalize_embeddings=True, batch_size=256).tolist()\n",
    "        return jsonify({\"embeddings\": vectores}), 200\n",
    "    except Exception as e:\n",
    "        return jsonify({\"error\": str(e)}), 500\n",
    "\n",
    "public_url = ngrok.connect(5000)\n",
    "print(f\"================================================================\")\n",
    "print(f\" \ud83d\ude80 SERVIDOR YOLO26 ACTIVO\")\n",
...
## [11/77] `volcar_todo_a_contexto.py`
...
## [13/77] `database/02_historico.sql`
...
## [14/77] `database/03_instructores_fuentes.sql`
...
## [15/77] `database/04_abm_bcnf.sql`
...
## [16/77] `database/05_usuarios.sql`
...
## [20/77] `frontend/service-worker.js`
...
## [24/77] `src/application/__init__.py`
...
## [25/77] `src/application/auth_controller.py`
...
## [26/77] `src/application/controllers.py`
...
## [27/77] `src/application/factory.py`
...
## [28/77] `src/application/fuente_controller.py`
...
## [29/77] `src/application/pattern_controller.py`
...
## [30/77] `src/application/profesor_controller.py`
...
## [31/77] `src/application/tecnica_controller.py`
...
## [33/77] `src/domain/interfaces.py`
...
## [36/77] `src/domain/validation_constants.py`
...
## [37/77] `src/infrastructure/__init__.py`
...
## [38/77] `src/infrastructure/mocks.py`
...
## [39/77] `src/infrastructure/adapters/__init__.py`
...
## [40/77] `src/infrastructure/adapters/colab_adapter.py`
...
## [41/77] `src/infrastructure/adapters/gemini_adapter.py`
...
## [42/77] `src/infrastructure/adapters/gemini_service_adapter.py`
...
## [43/77] `src/infrastructure/adapters/qdrant_adapter.py`
...
## [44/77] `src/infrastructure/adapters/qwen_embedding_adapter.py`
...
class QwenEmbeddingAdapter(IEmbeddingService):
        ...
        if not self.colab_url or self.colab_url.startswith("https://placeholder"):
            try:
                ...
                self._client = SentenceTransformer(
                    "Qwen/Qwen3-VL-Embedding-2B", device=self.device, trust_remote_code=True
                )
            except Exception:
                self._client = None
    ...
    def _llamar_colab_remoto(self, textos: List[str]) -> List[List[float]]:
        """Invoca el endpoint /embed de Colab agrupando en lotes de 256 para saturar la GPU."""
        ...
        try:
            for i in range(0, len(textos), batch_size):
                ...
                resp = requests.post(endpoint, json={"textos": lote}, timeout=180)
                ...
                if vectores and all(len(v) == self._dim for v in vectores):
                    ...
                    print(f"[WARN COLAB EMBEDDINGS] Dimensiones no esperadas en lote {i//batch_size}: {len(vectores)}")
                    resultados.extend([[0.05] * self._dim for _ in lote])
            return resultados
        except Exception as e:
...
## [45/77] `src/infrastructure/adapters/yolo_adapter.py`
...
## [46/77] `src/infrastructure/persistence/__init__.py`
...
## [47/77] `src/infrastructure/persistence/history_repository.py`
...
## [48/77] `src/infrastructure/persistence/postgres_repository.py`
...
## [49/77] `src/infrastructure/persistence/rag_ingestion.py`
...
## [50/77] `src/presentation/__init__.py`
...
## [52/77] `src/services/__init__.py`
...
## [53/77] `src/services/chunker_semantico.py`
...
## [54/77] `src/services/sintesis_pedagogica_service.py`
...
## [55/77] `tests/test_abm_contratos.py`
...
## [56/77] `tests/test_abm_fuentes.py`
...
## [57/77] `tests/test_abm_profesores.py`
...
## [58/77] `tests/test_abm_tecnicas.py`
...
## [59/77] `tests/test_api_abm_contratos.py`
...
## [60/77] `tests/test_api_tecnicas_bug.py`
...
## [61/77] `tests/test_application.py`
...
## [62/77] `tests/test_colab_adapter.py`
...
## [65/77] `tests/test_fuente_agrupacion.py`
...
## [66/77] `tests/test_integration.py`
...
## [67/77] `tests/test_iteracion3.py`
...
## [68/77] `tests/test_iteracion4.py`
...
## [69/77] `tests/test_iteracion5.py`
...
## [71/77] `tests/test_pwa_refactor.py`
...
## [72/77] `tests/test_rag_documentos_consolidados.py`
...
## [74/77] `tests/test_rag_stub_contrato.py`
...
## [75/77] `tests/test_sintesis_pedagogica.py`
...
## [76/77] `tests/test_ui_crud_tecnicas.py`
...
## [77/77] `tests/test_ui_simplicity.py`
